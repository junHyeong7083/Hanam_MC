...
/// <summary>
/// Director_Problem7_Step1 - 문제7 스텝1 Binder (concrete 클래스)
///
...
/// 【문제/스텝】 Director 테마 > 문제7 > 스텝1 (인트로/도입 - 드롭 박스 + 좌우 슬라이드)
/// 【부모 클래스】 Director_Problem2_Step1_Logic → ProblemStepBase
/// 【참조하는 곳】 씬의 Problem7 Step1 GameObject에 부착
/// 【흐름】 스텝 진입 → 좌/우 패널 슬라이드 인트로 → 드롭 박스에 아이템 드롭 → 완료
/// </summary>
public class Director_Problem7_Step1 : Director_Problem2_Step1_Logic
{
    [Header("Drop Box 영역")]
    ...
    [SerializeField] private float introDuration = 0.5f;           // 슬라이드 애니메이션 시간
    ...
    [SerializeField] private float introDelay = 0.1f;              // 인트로 시작 전 지연

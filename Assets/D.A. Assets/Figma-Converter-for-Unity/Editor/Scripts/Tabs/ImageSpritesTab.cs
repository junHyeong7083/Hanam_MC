...
namespace DA_Assets.FCU
{
    internal class ImageSpritesTab : MonoBehaviourLinkerEditor<FcuSettingsWindow, FigmaConverterUnity>
    {
        ...
        private void DrawGeneralSettings(VisualElement parent, SerializedProperty imageSpritesSettingsProp)
        {
            ...
            imageScaleSlider.value = monoBeh.Settings.ImageSpritesSettings.ImageScale;
            imageScaleSlider.RegisterValueChangedCallback(evt => monoBeh.Settings.ImageSpritesSettings.ImageScale = evt.newValue);
        ...
        private void DrawTextureImporterSettings(VisualElement parent)
        {
            ...
            crunchToggle.RegisterValueChangedCallback(evt => settings.CrunchedCompression = evt.newValue);
